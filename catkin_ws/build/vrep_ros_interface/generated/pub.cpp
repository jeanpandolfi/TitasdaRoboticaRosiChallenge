    ...
    else if(publisherProxy->topicType == "rosi_defy/HokuyoReading")
    {
        rosi_defy::HokuyoReading msg;
        read__rosi_defy__HokuyoReading(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "rosi_defy/RosiMovement")
    {
        rosi_defy::RosiMovement msg;
        read__rosi_defy__RosiMovement(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "rosi_defy/ManipulatorJoints")
    {
        rosi_defy::ManipulatorJoints msg;
        read__rosi_defy__ManipulatorJoints(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "rosi_defy/RosiMovementArray")
    {
        rosi_defy::RosiMovementArray msg;
        read__rosi_defy__RosiMovementArray(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
