...
#include <rosi_defy/HokuyoReading.h>
...
void write__rosi_defy__HokuyoReading(const rosi_defy::HokuyoReading& msg, int stack, const WriteOptions *opt = NULL);
void read__rosi_defy__HokuyoReading(int stack, rosi_defy::HokuyoReading *msg, const ReadOptions *opt = NULL);
...
void write__rosi_defy__RosiMovement(const rosi_defy::RosiMovement& msg, int stack, const WriteOptions *opt = NULL);
void read__rosi_defy__RosiMovement(int stack, rosi_defy::RosiMovement *msg, const ReadOptions *opt = NULL);
...
void write__rosi_defy__ManipulatorJoints(const rosi_defy::ManipulatorJoints& msg, int stack, const WriteOptions *opt = NULL);
void read__rosi_defy__ManipulatorJoints(int stack, rosi_defy::ManipulatorJoints *msg, const ReadOptions *opt = NULL);
...
void write__rosi_defy__RosiMovementArray(const rosi_defy::RosiMovementArray& msg, int stack, const WriteOptions *opt = NULL);
void read__rosi_defy__RosiMovementArray(int stack, rosi_defy::RosiMovementArray *msg, const ReadOptions *opt = NULL);
...
void ros_callback__rosi_defy__HokuyoReading(const boost::shared_ptr<rosi_defy::HokuyoReading const>& msg, SubscriberProxy *proxy);
...
void ros_callback__rosi_defy__RosiMovement(const boost::shared_ptr<rosi_defy::RosiMovement const>& msg, SubscriberProxy *proxy);
...
void ros_callback__rosi_defy__ManipulatorJoints(const boost::shared_ptr<rosi_defy::ManipulatorJoints const>& msg, SubscriberProxy *proxy);
...
void ros_callback__rosi_defy__RosiMovementArray(const boost::shared_ptr<rosi_defy::RosiMovementArray const>& msg, SubscriberProxy *proxy);
