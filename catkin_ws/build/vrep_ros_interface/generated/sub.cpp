    ...
    else if(in->topicType == "rosi_defy/HokuyoReading")
    {
        subscriberProxy->subscriber = nh->subscribe<rosi_defy::HokuyoReading>(in->topicName, in->queueSize, boost::bind(ros_callback__rosi_defy__HokuyoReading, _1, subscriberProxy));
    }
    ...
    else if(in->topicType == "rosi_defy/RosiMovement")
    {
        subscriberProxy->subscriber = nh->subscribe<rosi_defy::RosiMovement>(in->topicName, in->queueSize, boost::bind(ros_callback__rosi_defy__RosiMovement, _1, subscriberProxy));
    }
    ...
    else if(in->topicType == "rosi_defy/ManipulatorJoints")
    {
        subscriberProxy->subscriber = nh->subscribe<rosi_defy::ManipulatorJoints>(in->topicName, in->queueSize, boost::bind(ros_callback__rosi_defy__ManipulatorJoints, _1, subscriberProxy));
    }
    ...
    else if(in->topicType == "rosi_defy/RosiMovementArray")
    {
        subscriberProxy->subscriber = nh->subscribe<rosi_defy::RosiMovementArray>(in->topicName, in->queueSize, boost::bind(ros_callback__rosi_defy__RosiMovementArray, _1, subscriberProxy));
    }
