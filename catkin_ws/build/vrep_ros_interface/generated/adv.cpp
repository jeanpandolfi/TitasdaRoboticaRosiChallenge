    ...
    {
        publisherProxy->publisher = nh->advertise<rosi_defy::HokuyoReading>(in->topicName, in->queueSize, in->latch);
    }
    ...
    {
        publisherProxy->publisher = nh->advertise<rosi_defy::RosiMovement>(in->topicName, in->queueSize, in->latch);
    }
    ...
    {
        publisherProxy->publisher = nh->advertise<rosi_defy::ManipulatorJoints>(in->topicName, in->queueSize, in->latch);
    }
    ...
    {
        publisherProxy->publisher = nh->advertise<rosi_defy::RosiMovementArray>(in->topicName, in->queueSize, in->latch);
    }
